...
public class Cine {
	...
	public void altaSala(String nombreSala, int capacidad, Administrador adm) {
		...
		if (s == null) {
			...
			Sala.insertarSala(this.cuit,s);
			AsientoFisico.insertarAsiento(cuit, this.nombre, s.getAsientosFi());
	...
	public void bajaSala(String nombre) {
		Sala s = buscarSala(nombre);
		if (s != null) {
			salas.removeElement(s);
			s.borrarSalaBD(getCuit());
		}
	}	
	...
	public void bajaFuncion(String nombre, LocalTime horario, LocalDate dia){
